...
<html lang="en">
	<head>
		...
		<title>most profitable branches</title>
		...
		<body>
			...
			<h1>
				most profitable branch in the last week
			</h1>
			...
			<?php
				...
				$sql = "SELECT ROUND(SUM(`delievers`.`Deliever_fee`), 2) AS `most profitable`, `deliever scheduling`.`branch_id`
                ...
                if ($result -> num_rows > 0) {
					...
					echo "<table>
                            <tr>
                                <th> sum of fee from last week	</th>
                                <th> branch id		</th>
