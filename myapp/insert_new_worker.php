	...
	<head>
		...
		<body>
			...
			<div class="form-container">
				<h4>
					insert employee's data, then press save
				</h4>
				<form method="POST" action="?submit">
					...
					-->
					<h5>ID & date of birth</h5>

					<input type="number" name="empID" placeholder="ID" maxlength="9">
					<input type="date" name="birthDate">
					<h5>full name</h5>
					<input type="text" name="empFN" placeholder="first name" maxlength="20">
					<input type="text" name="empLN" placeholder="last name" maxlength="20">
					<h5>phone number & email address</h5>
					<input type="number" name="empNumber" placeholder="phone number" maxlength="12">
					<input type="text" name="empEmail" placeholder="email" maxlength="20">
					...
					<select id="Branches" name="branch">
						...
						<option value="3">Beit Shemesh					</option>
						<option value="4">Beer Sheva					</option>
						<option value="5">Haifa							</option>
					</select>
					<div class="save">
				...
				if(isset($_POST['submitForm']) && !empty($_POST['empID']))
				{
						// store the data in a variables
						$id = $_POST['empID'];
						...
						$sql = "INSERT INTO `worker`(`ID`,`First_Name`,`Last_Name`,`Phone_Number`,`License`,`Date_of_Birth`,`Starting_Date`,`position`,`branch`,`email_address`)
								VALUES('$id','$fn','$ln','$number','$license','$bday',NOW() ,'$position','$branch', '$mail')";
						...
						if ($connection->query($sql) === TRUE) {
							echo "<h4> New record created successfully </h4>";
							 ...
							 echo "<h4> Error: " . $sql . "<br>" . $connection->error. "</h4>";
