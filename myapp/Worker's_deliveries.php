...
<html lang="en">
	<head>
		...
		<title>worker's deliveries</title>
	...
	<body>
		...
		<div class="card">
			...
			<form method="post" action="?submit">
				...
				<h4>
					insert worker's id to get full deliveries info
				</h4>
				...
				-->
				<input type="text" name="workerID" placeholder="id" maxlength="9">
				<!--
				TODO : change name to meaningful name according to the content
				...
				if(isset($_POST['submitForm']))
				{
					...
					if(isset($_POST['workerID']))
					{
						...
						$sql = "SELECT *
                                ...
                                WHERE `deliever scheduling`.`id_worker` = $id" ;
