...
<html lang="en">
	<head>
		...
		<title>number of deliveries today</title>
		...
		<body>
			...
			<?php
				...
				$sql = "SELECT COUNT(*) AS `deliveries today`
                        FROM `delievers`
                ...
                $num = intval($data['deliveries today']);
                ...
                if ($num == 1)
                {
                    echo "1 delivery today";
                }
                if ($num > 1)
                {
                    echo $num." deliveries today";
                }
